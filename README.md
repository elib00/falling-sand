**git checkout single-sand-version** => This version lets you add single grains of sand into the grid so that you can clearly see the interactions between each sand particle
